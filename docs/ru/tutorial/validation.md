...
Когда данные запроса не проходят валидацию Pydantic, django-pydantic автоматически возвращает структурированный ответ **HTTP 422 Unprocessable Entity**. Эта страница объясняет формат ошибок и способы кастомизации.
