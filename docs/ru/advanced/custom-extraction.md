...
По умолчанию django-pydantic объединяет GET-параметры, POST/JSON тело и URL kwargs. Если для конкретной схемы нужно другое поведение — переопредели логику извлечения.
